 ...
 *
 * This module is responsible for constructing banner images (URL generation)
 * used by the frontend after a teacher uploads a Cloudinary asset.
 */
...
export const bannerPhoto = (imageCldPubId: string, name: string) => {
  return (
    cld
      ...
      .resize(
        fill().width(1200).height(297) // Keep a consistent 5:1 banner aspect ratio
      )
      // Optimize for web

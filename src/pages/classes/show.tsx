 ...
 * Class details page.
 *
 * Renders class metadata plus:
 * - teacher/student roster (server table filtered by `role`)
 * - Cloudinary banner image (generated via `bannerPhoto`)
 * - join-class UX for demo enrollment flow
 */

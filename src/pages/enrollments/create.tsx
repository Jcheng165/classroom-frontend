/**
 * Enrollment creation page.
 *
 * Lets the currently authenticated user select a class and creates an enrollment.
 * Uses `useGetIdentity()` to derive `studentId` (so students can't enroll as others).
 */
